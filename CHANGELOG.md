...
- Human implementation guide and plain-text AI-assisted implementation guide with approval gates, prompt-injection mitigations, and a SHA-256 provenance sidecar
